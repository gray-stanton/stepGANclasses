...
import texar
import random
BASEDIR = '/home/gray/stepGANclasses/out/'

def get_config_file(trp, usp):
    if usp == -1:
        'stepGAN_base_config_nogan'
    if usp == 0.0:
...
unsup_revs_path = '/home/gray/stepGANclasses/chicago_unlab_reviews.txt'

train_revs = '/home/gray/stepGANclasses/opspam_train_reviews.txt'
train_labs = '/home/gray/stepGANclasses/opspam_train_labels.txt'
test_revs = '/home/gray/stepGANclasses/opspam_test_reviews.txt'
test_labs = '/home/gray/stepGANclasses/opspam_test_labels.txt'
...
# 0.5, 0.8 x 0.5, 0.8
for train_pcent in [0.5, 0.7, 0.9, 1.0]:
