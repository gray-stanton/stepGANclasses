...
unsup_rev_paths = {
    ...
    0.8 : '/home/gray/code/stepGAN/chicaco_unlab_reviews80.txt',
...
def make_data(trp, usp, run):
    ...
    vocab = texar.data.make_vocab([train_revs, unsup_rev_paths[usp]], 10000)
...
for train_pcent in [0.5, 0.6, 0.7, 0.8, 0.9, 1.0]:
    for unsup_pcent in [0.5, 0.6, 0.7, 0.8, 0.9, 1.0]:
        for run in range(10):
            ...
            # inject file paths
            base_config.train_data_reviews = data_paths['train_data_reviews']
            base_config.train_data_labels = data_paths['train_data_labels']
            base_config.val_data_reviews = data_paths['val_data_reviews']
            base_config.val_data_labels = data_paths['val_data_labels']
            base_config.test_data_reviews = test_revs
            base_config.test_data_labels = test_labs
            base_config.vocab = data_paths['vocab']
